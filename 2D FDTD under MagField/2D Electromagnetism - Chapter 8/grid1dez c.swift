...
public func gridInit1d() -> Void {
    ...
    g1.hy = Array(repeating: 0.0, count: SizeX() - 1)
    g1.chyh = Array(repeating: 0.0, count: SizeX() - 1)
    g1.chye = Array(repeating: 0.0, count: SizeX() - 1)
    g1.ez = Array(repeating: 0.0, count: SizeX())
    g1.cezh = Array(repeating: 0.0, count: SizeX())
    g1.ceze = Array(repeating: 0.0, count: SizeX())
