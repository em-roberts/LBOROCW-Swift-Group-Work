...
public func Hz1 (_ m: Int) -> Double {
    return g1.hz[m]
}
public func Chzh1 (_ m: Int) -> Double {
    return g1.chzh[m]
}
public func Chze1 (_ m: Int) -> Double {
    return g1.chze[m]
}

public func Ey1 (_ m: Int) -> Double {
    return g1.ey[m]
}
public func Ceye1 (_ m: Int) -> Double {
    return g1.ceye[m]
}
public func Ceyh1 (_ m: Int) -> Double {
    return g1.ceyh[m]
}
