...
public func gridInit(_ g: Grid) -> Grid {
    ...
    for mm in 1 ..< temp.sizeX {
        for nn in 1 ..< temp.sizeY {
            temp.ceze[twoD(mm, nn, nnEnd: temp.sizeY)] = 1.0
            temp.cezh[twoD(mm, nn, nnEnd: temp.sizeY)] = g.cdtds * imp0
        }
    }
    
    for mm in 1 ..< temp.sizeX {
        for nn in 1 ..< temp.sizeY - 1 {
            temp.chxh[twoD(mm, nn, nnEnd: temp.sizeY - 2)] = 1.0
            temp.chxe[twoD(mm, nn, nnEnd: temp.sizeY - 2)] = g.cdtds / imp0
        }
    }
    
    for mm in 1 ..< temp.sizeX - 1 {
        for nn in 1 ..< temp.sizeY {
            temp.chyh[twoD(mm, nn, nnEnd: temp.sizeY)] = 1.0
            temp.chye[twoD(mm, nn, nnEnd: temp.sizeY)] = g.cdtds / imp0
        }
    }
    return temp
}
